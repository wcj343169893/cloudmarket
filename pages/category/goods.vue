							...
							<view class="weui-flex">
								...
								<view class="desc weui-flex__item">
									...
									<view class="buttons">
										...
										<view class="sku_button" v-if="item.yuding">
											<text class="sku_btn" @click="navToGoodsPage(item)">查看</text>
										</view>
										...
										<uni-number-box v-else :min="0" :max="item.limit" :stock="item.stock" :disabled="!hasLogin" :keys="category.pid+'_'+item.id" :value="goodsCartNumber[item.id]" @disabledEvent="showLoginDialog" @change="bindChange"></uni-number-box>
									</view>
								</view>
							</view>
						</view>
			...
			<view class="loginDialog">
				...
				<view class="weui-flex">
					<view class="weui-flex__item">
						<text class="btn btn_ok" @click="navToLoginPage()">登录</text>
					</view>
			...
			<view class="skuDialogPanel">
				...
				<view v-for="(item,index) in skuGoods.skuNameMap" :key="index">
					...
					<view class="skuoptions">
						...
						:class="{active:item.active== index2,disabled:sname.disabled}" @click="selectSku(index,index2)">
				...
				<view class="sku_prices_buttons">
					...
					<view class="sku_prices_buttons__btn" v-if="skuCart[skuGoods.id]">
						<uni-number-box :min="0" :max="skuGoods.limit" :stock="skuGoods.stock" :keys="skuGoods.catPid+'_'+skuGoods.id" :value="skuCart[skuGoods.id][skuGoods.selectedSkuId]" @change="bindChangeSku"></uni-number-box>
					</view>
				</view>
			</view>
